...
(http://godoc.org/github.com/conseweb/coinutil/bloom)
...
```bash
$ go get -u github.com/conseweb/coinutil/bloom
```

## Examples

* [NewFilter Example]
  (http://godoc.org/github.com/conseweb/coinutil/bloom#example-NewFilter)  
